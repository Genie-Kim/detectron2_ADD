...
cfg.merge_from_file('./module_jinkim/faster_rcnn_R_101_C4_3x_rotated.yaml')
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        return build_detection_train_loader(cfg, mapper=ADDDatasetMapper(cfg, True)) # custum dataset mapper 를 만들어야 함


os.makedirs(cfg.OUTPUT_DIR, exist_ok=True)
trainer = Trainer(cfg) # 이거를 DefaultTrainer를 상속한 다른 클래스로 고치자. 예시 : https://github.com/facebookresearch/detectron2/blob/master/projects/DensePose/train_net.py
